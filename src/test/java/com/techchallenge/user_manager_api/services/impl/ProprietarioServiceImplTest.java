...
class ProprietarioServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        proprietarioService = new ProprietarioServiceImpl(proprietarioRepository, passwordService);
    }

    @Test
    void deveriaRetornarSucessoAoCadastrarProprietario() {
        // ARRANGE
    ...
    @Test
    void deveriaRetornarSucessoAoBuscarProprietarioPorId() {
        //ARRANGE
        Long id = 1L;
        Proprietario proprietarioMock = mock(Proprietario.class);
        when(proprietarioMock.getId()).thenReturn(id);
        when(proprietarioMock.getCnpj()).thenReturn("12345678000190");
        when(proprietarioMock.getEmail()).thenReturn("maria@email.com");
        ...
        assertEquals("12345678000190", resultado.cnpj());
    }

    @Test
    void deveriaRetornarErroAoBuscarProprietarioPorId() {
        //ARRANGE
        Long id = 1L;
